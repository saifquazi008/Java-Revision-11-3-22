...
public class MapDemo {
	...
	public static void main(String[] args) {
		...
		Map<String, String> map1 = new HashMap<String, String>(); // store key value + no insertion order
		Map<String, String> map2 = new LinkedHashMap<String, String>(); // store key value + insertion order
		Map<String, String> map3 = new TreeMap<String, String>(); // store key value pair + order by key -> asc keys
